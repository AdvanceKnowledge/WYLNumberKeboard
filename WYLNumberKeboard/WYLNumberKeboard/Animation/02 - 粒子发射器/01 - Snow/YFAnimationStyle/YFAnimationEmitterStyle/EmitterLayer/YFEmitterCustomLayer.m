...
+(void)addSnowLayerInView:(UIView *)view
{
    ...
    [YFEmitterCustomLayer snowLayerInView:view atPosition:CGPointMake(-60,view.frame.size.height*0.33) andDirection:YFEmitterParticleCellDirectionToTop andRadious:14 andCellImg:nil];
